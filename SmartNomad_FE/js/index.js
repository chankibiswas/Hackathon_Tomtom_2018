...
(function() {
    ...
    var sidebarEl;
    var API_KEYS = [{
        placeholder: '2taJDBchWSpd6FlGd027ACPhD9cIzkto',
        name: 'api.key',
        label: 'Maps API key'},
    {
        placeholder: '2taJDBchWSpd6FlGd027ACPhD9cIzkto',
    ...
    EXAMPLES.load = function(exampleId) {
        ...
        CodepenLinkGenerator.prototype.getJavascriptCodeForCodepen = function(code, keys) {
            var generatedCode = code
                ...
                .replace(/<your-product-version>/g, '1')
                .replace(/<your-product-name>/g, 'Codepen Examples')
                .replace(/<your-tomtom-sdk-base-path>/g, 'https://api.tomtom.com/maps-sdk-js/4.30.4/examples/sdk');

            if (generatedCode.match(/^\s*require\(\[.*/g)) {
                var requireConfig = {
                    baseUrl: 'https://api.tomtom.com/maps-sdk-js/4.30.4/examples'
                };
        ...
        function parseCode(response) {
            ...
            displayReponse = response.replace(/${api.key}/g, '<your-tomtom-API-key>')
                .replace(/smartnomad/g, '<your-product-name>')
                .replace(/\/sdk/g, '<your-tomtom-sdk-base-path>')
                .replace(/1/g, '<your-product-version>')
